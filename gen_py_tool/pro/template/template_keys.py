...
'''
 ...
 Info
     Defined class TemplateKeys with attribute(s).
     Created attributes for processing tool/gen template.
'''
...
class TemplateKeys:
    ...
    TOOL_TEMPLATE, GEN_TEMPLATE = 'tool', 'generator'
    SUPPORTED_TEMPLATES = [TOOL_TEMPLATE, GEN_TEMPLATE]
