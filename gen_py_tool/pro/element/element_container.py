...
'''
 ...
 Info
     Defined class ElementContainer with attribute(s) and method(s).
     Created API for element container.
'''
...
class ElementContainer:
    ...
    def __init__(self, verbose=False):
        ...
        self.__element = None
        verbose_message(
            ElementContainer.GEN_VERBOSE, verbose, 'init element API util'
        )
    ...
    def element(self, element):
        ...
        verbose_message(
            ElementContainer.GEN_VERBOSE, self.__verbose,
            'set element', element
        )

    def is_element_ok(self):
        '''
        ...
        '''
        return all([
            self.__element is not None, isinstance(self.__element, dict)
        ])

    def __str__(self):
        '''
            Dunder method for ElementContainer.
        ...
        '''
        return '{0} ({1}, {2})'.format(
            self.__class__.__name__, str(self.__verbose), str(self.__element)
        )
